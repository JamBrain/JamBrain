	...
	render( props, state ) {
		return (
			<div class="sidebar-base sidebar-shortlist sidebar-upcoming">
				...
				<div class="-summary -gap"><NavLink href="https://ldjam.com/events/ludum-dare/48/$233336/ludum-dare-is-hiring-a-senior-developer-in-canada"><img src="https://static.jam.vg/content/b/z/42c46.jpg.w240.jpg" /></NavLink></div>
			</div>
		);
	}
}
