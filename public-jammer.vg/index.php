...
<br />
To avoid confusion, I've disabled this website for now. Effectively though, <strong>ludumdare.com</strong> (<strong><a href="https://ldjam.com">ldjam.com</a></strong> during alpha testing) and <strong>jammer.vg</strong> are the same. They do the same thing, share the same data, and work the same way. But the distinction will be more and more important in time. It lets <strong>ludumdare.com</strong> specfically focus on <strong>Ludum Dare</strong>. It can streamline things by assume you're there to participate in <strong>Ludum Dare</strong>, it can brag about the <strong>Ludum Dare</strong> games on <strong>Steam</strong> and <strong>PlayStation 4</strong>, or push tips and tricks on how to best use your 48 and 72 hours. <strong>Jammer</strong> can then become a l-encompassing, collecting and archiving data from other jams (forgotten jams as well) all in one place. Like a Mobygames or Wikipedia of jamming. And because they share the same core, <strong>Ludum Dare</strong> data is automatically part of it, and in turn will also benefit from things expanding on the other side (data on tool usage, trends in game jams, etc).<br />
<br />
