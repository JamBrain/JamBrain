	...
	render( props, state ) {
		...
		return (
			<div class="header-base header-noob outside">
				...
				<div class="-gap"><strong>Ludum Dare</strong> is one of the world's largest and longest running Game Jam events. Every 6 months, we challenge creators to make a game <em>from scratch</em> in a weekend.</div>
