...
export default function PageNavEventMy( props ) {
	const {node, parent, superparent, author, user, path, extra, ...otherProps} = props;
...
//	let IsMe = ['/my'].includes(FirstPath);
	...
	return <nav class="content -nav">{NavButtons}</nav>;
}
