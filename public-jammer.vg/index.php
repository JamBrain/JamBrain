Coming soon! For now, go to <strong><a href="https://ldjam.com">ldjam.com</a></strong>.<br />
<br />
...
<br />
So as the network of <strong>Ludum Dare</strong> related web projects grew, it made sense give them a new identity. And because it sounded appropriate (and cool), I chose to name it <strong>Jammer</strong>. So when <strong>Ludum Dare</strong> tells you to make a <strong>Jammer</strong> account, that is us telling you to make an account for <strong>Ludum Dare</strong> and our <strong>future</strong> stuff.<br />
<br />
Game Jamming is a thing now. It's a culture, and a way of life. As it matures, to keep it moving forward, we need to do better by preserving and organizing that culture. Being the premier <strong>online</strong> jam, <strong>Ludum Dare</strong> has become the home of a huge community of makers from around the world. I'm extremely humbled by this. Despite our flaws, our ups and downs, you've stuck with us for nearly 15 years. So I feel it's our responsibilty to be spearheading this effort. Be part of the solution, the evolution, rather than just being one more place to jam on the internet. I'm not the best leader, and I've certainly made mistakes, but I've been here this whole time. This is something I deeply care about, and though it may take time, I'm seeing it through (whether we like it or not). 😉<br />
<br />
The new <strong>ludumdare.com</strong> (currently alpha-testing on <strong><a href="https://ldjam.com">ldjam.com</a></strong>) is the first step. The focus is on main events. This here, <strong>Jammer</strong>, is the next step.<br />
<br />
To avoid confusion, I've disabled this website for now. Effectively though, <strong>ludumdare.com</strong> (<strong><a href="https://ldjam.com">ldjam.com</a></strong> during alpha testing) and <strong>jammer.vg</strong> are the same. They do the same thing, share the same data, and work the same way. But the distinction will be more and more important in time. It lets <strong>ludumdare.com</strong> specfically focus on <strong>Ludum Dare</strong>. It can streamline things by assuming you're there to participate in the <strong>Ludum Dare</strong>, it can brag about the <strong>Ludum Dare</strong> games on <strong>Steam</strong> and <strong>PlayStation 4</strong>, or push tips and tricks on how to best use your 48 and 72 hours. <strong>Jammer</strong> can then become all encompassing, collecting and archiving data from other jams, forgotten jams, jam-like things, all in one place. Like a Mobygames or Wikipedia of jamming. And because they share the same core, <strong>Ludum Dare</strong> data is automatically part of it, and in turn will also benefit from things expanding on the other side (data on tool usage, trends in game jams, etc).<br />
<br />
